...
# Note: for lifecycle multiline comments (## HANDOFF, ## PROGRESS, etc.),
# use WIT comments API via `az devops invoke` with JSON --in-file payload.
# See orchestrator-boot/references/CORE.md universal comment convention.
